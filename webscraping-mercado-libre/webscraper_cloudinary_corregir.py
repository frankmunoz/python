...
try:
    ...
    while True:
        ...
        if "resources" in resources:
            # Itera sobre cada recurso y cambia el nombre de la imagen si tiene la extensión duplicada
            for resource in resources["resources"]:
                antiguo_nombre = resource["public_id"]
                
                # Verifica si el nombre de la imagen termina con ".jpg.jpg"
                if antiguo_nombre.endswith(".jpg.jpg"):
                    # Elimina la extensión duplicada y renombra la imagen
                    nuevo_nombre = antiguo_nombre[:-4] + ".jpg"
                    print(nuevo_nombre)
                    ...
                    print(f"Imagen {antiguo_nombre} NO renombrada")
        else:
